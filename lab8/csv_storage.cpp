...
int CsvStorage::getNewInventionId()
{
    int max = 0;
...
vector<Inventor> CsvStorage::getAllInventors()
{
...
bool CsvStorage::updateInventor(const Inventor &inventor)
{
...
int CsvStorage::insertInventor(const Inventor &inventor)
{
...
vector<Invention> CsvStorage::getAllInventions()
{
    return this->inventions_;
}

optional<Invention> CsvStorage::getInventionById(int inventor_id)
{
    for (Invention &inv : this->inventions_)
    {
        if (inv.id == inventor_id)
...
bool CsvStorage::updateInvention(const Invention &invention)
{
...
bool CsvStorage::removeInvention(int invention_id)
{
    for (int i = 0; i < inventions_.size(); i++)
    {
...
int CsvStorage::insertInvention(const Invention &invention)
{
